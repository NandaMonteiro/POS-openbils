...
public class ReceitaComiteValor implements Serializable {
    ...
    public ReceitaComiteValor(String nome_comite, double valor, double quantidade_orgaos) {
    ...
    public String toString() {
        return "ReceitaComiteValor{" + "nome_comite=" + nome_comite + ", valor=" + valor + ", quantidade_orgaos=" + quantidade_orgaos + '}';
    }
